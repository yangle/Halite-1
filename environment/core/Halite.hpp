...
private:
    ...
    void output(std::string filename, unsigned int seed, const std::vector<PlayerStatistics>& player_statistics, bool concise, bool progression);
public:
    ...
    GameStatistics runGame(std::vector<std::string> * names_, unsigned int seed, bool append_seed, bool concise, bool progression, bool enabledReplay, std::string replayDirectory, const std::string& outputFilename);
